...
<body>
    ...
    <section id="sec1About">
           ...
           <section class="tabcontent">
                <form action="addStylist.php" method="GET" novalidate>
               <p>    Name of the stylist: <input type="text" name="styname" id="styname" required><span id="err1" style="color:red;"></span></p><br>
                <p>   Category: <select id="stylist" name="stylist" onchange='updateMyText()'>
                <option value="">---- Select the category -----</option>
                    ...
                    </select><span id="err2" style="color:red;"></span><br><br>
                    <input type="text" name="xx1" id="xx1" style="display:none" required>
                    <input type="text" name="xx" id="xx" style="display:none" required></p><br>
...
document.getElementsByName('xx1')[0].value=ddtext1;
      ...
      btn1.onclick = function (e) {
       ...
       {
           var checkes=1;
           var names=document.getElementById('styname');
