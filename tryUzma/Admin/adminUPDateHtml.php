...
<form method="GET" action="UpdatePHP.php" novalidate>
           <select name="x" id="x" onchange='updateMyText()' >
...
$result = $conn->query("select ID,servicename,serviceamount FROM Service");
...
?> 
</select><span id="err2" style="color:red;"></span>

&nbsp;&nbsp;&nbsp;<input type="text" name="xx" id="xx" style="display:none" required><br><br>
Enter the amount to be updated &nbsp;&nbsp;&nbsp;<input type="text" pattern="[0-9]{1,5}" id="serviceAmount" name="serviceAmount" required><span id="err1" style="color:red;"></span><br><br>
...
document.getElementsByName('xx')[0].value=ddtext;
      ...
      btn1.onclick = function (e) {
        ...
        function checking()
       {
           ...
           var seramount=document.getElementById('serviceAmount');
           if(seramount.checkValidity)
	        {
                //alert(names.validationMessage);
	            document.getElementById("err1").innerHTML=seramount.validationMessage;
                if(seramount.validationMessage.toString().length!=0)
                    checkes=0;
	        }
