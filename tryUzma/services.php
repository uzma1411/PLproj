    ...
    <section id="sec1About">
        ...
        <article>
            <div class="caption"><br><br>
              <a href="makeup.php">  <button class="btnn">Makeup</button></a>
              <a href="hair.php">   <button class="btnn">Hair Styling and Treatment</button></a>
              <a href="facial.php">   <button class="btnn">Facial</button></a>
               
                <br>
                <a href="bodyps.php">   <button class="btnn">Body polish</button></a>
                <a href="desp.php">     <button class="btnn">Depilatory Services</button></a>
