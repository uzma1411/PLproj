...
<body>
    ...
    <nav class="animate-bottom ">
        <a href="HOME.html" style="right:20px;">Home</a>
        <a href="aboutUs.html" style="right:20px;">Look Book</a>
        <a href="services.html" style="left:50px;color: rgb(28, 20, 138);">Services</a>
        <a href="cc.html" style="left:50px">Contact Us</a>
    </nav>
